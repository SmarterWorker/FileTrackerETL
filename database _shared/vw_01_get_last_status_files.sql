...
/****** Object:  View [dbo].[vw_get_last_status_files]    Script Date: 17/07/2021 09:40:26 ******/
SET ANSI_NULLS ON
GO
...
INNER JOIN file_info tf ON tfs.file_status_id = tf.file_status_id AND tf.sort_group = tfs.group_name) as ok
WHERE rownums = 1 ),
